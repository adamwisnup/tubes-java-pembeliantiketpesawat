 ...
 */
public class AlertClosing extends javax.swing.JFrame {

    /**
     * Creates new form ALertClosing
     */
    public AlertClosing() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TERIMAKASIH SUDAH MEMBELI :)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertClosing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlertClosing().setVisible(true);
            }
        });
    }
